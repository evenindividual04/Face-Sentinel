...
from architectures.HybridEfficientNetAutoAttViT import HybridEfficientNetAutoAttViT
...
EfficientNetB4AttSECBAMFusion = EfficientNetB4AttSECBAMFusion
HybridEfficientNetAutoAttViT = HybridEfficientNetAutoAttViT
